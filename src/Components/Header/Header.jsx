  ...
  return (
    <header className={styles.header}>
      ...
      <div className={styles.headerInfo}>
        <a href="https://www.notion.so/THE-BEST-PLANNER-EVER-5078e09873a046fb9306bbcdfe356fb3">
          <svg className={styles.faq} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path d="M6,22h15v-2H6.012C5.55,19.988,5,19.805,5,19s0.55-0.988,1.012-1H21V2H6C4.794,2,3,2.799,3,5v3v6v3v2 C3,21.201,4.794,22,6,22z M8,6h9v2H8V6z" fill="#747E8A"/>
          </svg>
        </a>
        <div>
          <svg className={styles.bell} width="26" height="26" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
