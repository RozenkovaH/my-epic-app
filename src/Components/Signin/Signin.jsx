  ...
  return (
    <div className={styles.page}>
      ...
      <svg className={styles.abstractShapes} position="fixed" top="0" bottom="0" left="0" right="0" viewBox="0 0 1440 780" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 760.678V60C33.5288 69.7493 127.541 199.033 122.281 405.464C118.074 570.609 39.0073 711.084 0 760.678Z" fill="#EE00AB" fillOpacity="0.6" />
        <path d="M129.623 452.676C115.738 248.198 37.4225 135.523 0 104.746V780C48.9927 756.091 143.507 657.154 129.623 452.676Z" fill="#EE00AB" fillOpacity="0.4" />
        <path d="M1440 0H889.898C989.023 210.93 1297.93 228.919 1440 227.275V0Z" fill="#0073F7" fillOpacity="0.6" />
        <path d="M1440 0H784.854C861.041 13.0355 994.258 130.205 1045.35 155.254C1123.98 193.804 1208.72 206.189 1274.6 206.52C1342.31 206.859 1419.02 202.644 1440 199.046V0Z" fill="#0073F7" fillOpacity="0.6" />
        <path d="M1440 0H985.891H631.894C813.177 0 872.251 73.2642 1022.42 146.528C1142.55 205.14 1350.86 190.303 1440 175.558V0Z" fill="#0073F7" fillOpacity="0.5" />
      </svg>
    </div>
  )
}
